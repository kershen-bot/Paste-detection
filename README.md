...
1. Start the app up
2. Paste with Crl+V into the text box that says "Enter the text you want to type"
3. Choose if you want it to have a typo or not by pressing the check mark.
4. Press the "Start Typing" button
5. It gives you 5 seconds, so click away from the app and click to where you want to type
